...
export const VMIX_COMMAND_CATALOG: VmixCommandDefinition[] = [
  ...
  { functionName: 'StartStopRecording', label: 'Alternar gravacao', category: 'recording', risk: 'high', retryable: true },
  ...
  { functionName: 'StartStopStreaming', label: 'Alternar streaming', category: 'streaming', risk: 'high', retryable: true },
  { functionName: 'FadeToBlack', label: 'Fade to Black (FTB)', category: 'output', risk: 'high', retryable: true },
  { functionName: 'StartExternal', label: 'Iniciar External', category: 'output', risk: 'high', retryable: true },
  { functionName: 'StopExternal', label: 'Parar External', category: 'output', risk: 'high', retryable: true },
  { functionName: 'StartStopExternal', label: 'Alternar External', category: 'output', risk: 'high', retryable: true },
  { functionName: 'External', label: 'Alternar External', category: 'output', risk: 'high', retryable: true },
  { functionName: 'FullscreenOn', label: 'Fullscreen on', category: 'output', risk: 'medium', retryable: true },
  { functionName: 'FullscreenOff', label: 'Fullscreen off', category: 'output', risk: 'medium', retryable: true },
  { functionName: 'Fullscreen', label: 'Alternar Fullscreen', category: 'output', risk: 'medium', retryable: true },
  ...
  { functionName: 'SetOutputExternal2', label: 'External 2', category: 'output', risk: 'high', requiresValue: true, valueLabel: 'fonte', retryable: true },
  { functionName: 'SetOutputFullscreen', label: 'Fullscreen 1', category: 'output', risk: 'high', requiresValue: true, valueLabel: 'fonte', retryable: true },
  { functionName: 'SetOutputFullscreen2', label: 'Fullscreen 2', category: 'output', risk: 'high', requiresValue: true, valueLabel: 'fonte', retryable: true },
  { functionName: 'StartSRTOutput', label: 'Iniciar SRT Output', category: 'streaming', risk: 'high', retryable: true },
  { functionName: 'StopSRTOutput', label: 'Parar SRT Output', category: 'streaming', risk: 'high', retryable: true },
  { functionName: 'StartStopSRTOutput', label: 'Alternar SRT Output', category: 'streaming', risk: 'high', retryable: true },
  { functionName: 'StartMultiCorder', label: 'Iniciar MultiCorder', category: 'recording', risk: 'high', retryable: true },
  { functionName: 'StopMultiCorder', label: 'Parar MultiCorder', category: 'recording', risk: 'high', retryable: true },
  { functionName: 'StartStopMultiCorder', label: 'Alternar MultiCorder', category: 'recording', risk: 'high', retryable: true },
  { functionName: 'Snapshot', label: 'Snapshot do Output', category: 'output', risk: 'low', retryable: true },
  { functionName: 'SnapshotInput', label: 'Snapshot de Input', category: 'output', risk: 'low', requiresInput: true, retryable: true },
  ...
  { functionName: 'SetLoop', label: 'Loop on/off', category: 'playback', risk: 'low', requiresInput: true, requiresValue: true, valueLabel: '1 (ativar) / 0 (desativar)', retryable: true },
  { functionName: 'StopInput', label: 'Parar input', category: 'playback', risk: 'low', requiresInput: true, retryable: true },
]
