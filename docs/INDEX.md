...
> Versão **5.5.37** — Atualizado em **26/05/2026** — Hotfix crítico: Autoplay Comercial agora inicia a programação do zero quando o app está idle (stateRef stale fix + startScheduleFromItem)
