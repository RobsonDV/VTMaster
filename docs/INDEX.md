...
> Versão **5.5.42** — Atualizado em **02/06/2026** — Botão "Regenerar do zero" na Programação do Dia (corrige um dia que abriu já executado). Inclui v5.5.41 (dia sempre fresco no startup) e v5.5.40 (Autostart, Stop/Pause preservam o input no ar, disparo de comercial correto, retomada global)
