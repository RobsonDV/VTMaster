...
> Versão **5.5.40** — Atualizado em **02/06/2026** — Autostart (cold-start independente, janela de 5 min), Stop/Pause preservam o input no ar, disparo de comercial correto (mutex + match por arquivo) e retomada de sessão global
