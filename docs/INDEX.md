...
> Versão **5.5.36** — Atualizado em **26/05/2026** — Scheduler comercial robusto (firedCommercialTimesRef + localStorage), widget de diagnóstico, hardening de produção: I/O async, retry limitado, items playing no startup, logs DEV-only, schema versioning
