...
> Versão **5.5.41** — Atualizado em **02/06/2026** — Programação do Dia não abre mais "já executada" (status obsoletos de outro dia eram mantidos no startup); a cada novo dia vem fresca. Inclui v5.5.40 (Autostart, Stop/Pause preservam o input no ar, disparo de comercial correto, retomada global)
